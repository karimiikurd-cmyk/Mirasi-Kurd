...
export const HISTORICAL_FIGURES: HistoricalFigure[] = [
  ...
  },
  {
    ...
    {
    id: 'mulla-mustafa-barzani',
    name: 'مەلا مستەفا بارزانی',
    kurdishName: 'مەلا مستەفا بارزانی (١٩٠٣ - ١٩٧٩ ز)',
    alternateNames: [
      'مەلا مستەفا',
      'Mustafa Barzani',
      'Mulla Mustafa Barzani',
      'Mela Mistefayê Barzanî',
      'پێشەوا مستەفا بارزانی'
    ],
    ...
    birthYear: '١٩٠٣ ز',
    deathYear: '١٩٧٩ ز',
    birthDate: '١٤ی ئاداری ١٩٠٣ ز',
    deathDate: '١ی ئاداری ١٩٧٩ ز',

    period: 'سەدەی ٢٠',
    region: 'کوردستانی عێراق',
    cityOrPlace: 'بارزان / هەولێر',
    ...
    biography: `مەلا مستەفا بارزانی یەکێک لە ناسراوترین سەرکردە سیاسی و سەربازییەکانی بزوتنەوەی نەتەوەیی کورد لە سەدەی بیستەم بوو. لە بارزان لەدایک بوو و لە چەندین بزووتنەوە و شۆڕشی کوردی بەشداری و ڕابەرایەتی کرد. لە ساڵی ١٩٤٦دا لە کۆماری کوردستان لە مەهاباد بە پلەی جەنەڕاڵی سوپا ناسرا. دوای ڕووخانی کۆماری مەهاباد، بارزانی و گرووپێک لە پێشمەرگەکانی بەرەو یەکێتیی سۆڤیەت چوون و نزیکەی دوازدە ساڵ لەوێ مایەوە. لە ١٩٥٨دا دوای گۆڕانکارییە سیاسییەکانی عێراق گەڕایەوە و دووبارە ڕۆڵێکی سەرەکی لە بزوتنەوەی کوردیی عێراقدا گێڕا. لە ساڵی ١٩٧٥دا دوای کۆتایی هاتنی شۆڕشی ئەیلوول بەرەو ئێران و دواتر بۆ ئەمریکا چوو و لە واشنتن لە ساڵی ١٩٧٩دا کۆچی دوایی کرد.`,

    achievements: [
      'بەشداری و ڕابەرایەتیکردنی هێزە کوردییەکان لە کۆماری کوردستانی مەهاباد لە ١٩٤٦دا',
      'ڕۆڵی سەرەکی لە دامەزراندن و ڕێبەرایەتیکردنی پارتی دیموکراتی کوردستان',
      'ڕابەرایەتیکردنی چەندین قۆناغی بزوتنەوەی سیاسی و سەربازیی کورد لە عێراق',
      'ڕابەرایەتیکردنی شۆڕشی ئەیلوول لە ١٩٦١ تا ١٩٧٥',
      'بوون بە یەکێک لە کاریگەرترین سەرکردەکانی بزوتنەوەی نەتەوەیی کورد لە سەدەی بیستەم'
    ],

    works: [
      'وتار و بەیاننامە سیاسییەکان',
      'نامە و پەیامەکانی بزوتنەوەی کوردی',
      'یادداشت و گفتوگۆکانی پەیوەندیدار بە بزوتنەوەی کوردی'
    ],

    historicalImportance: 'مەلا مستەفا بارزانی یەکێکە لە کاریگەرترین سەرکردە سیاسی و سەربازییەکانی مێژووی نوێی کورد. ژیانی سیاسیی لە چەندین قۆناغی گرنگی بزوتنەوەی کوردی، لە کۆماری مەهابادەوە تا شۆڕشی ئەیلوول، پەیوەندییەکی ڕاستەوخۆی هەبوو و بووە سیمبولێک بۆ بزوتنەوەی نەتەوەیی کورد لە سەدەی بیستەمدا.',

    kurdishIdentityStatus: 'پشتڕاستکراو',

    disputeNote: 'لە سەرچاوەکاندا لەسەر ساڵی لەدایکبوونی بارزانی جیاوازییەکی بچووک هەیە؛ زۆرێک لە سەرچاوەکان ١٩٠٣ ز دەنووسن، بەڵام هەندێک سەرچاوەی ئەکادیمی ١٩٠٤ ز هێناون.',

    sources: [
      {
        title: 'BĀRZĀNĪ - Encyclopaedia Iranica',
        author: 'Martin van Bruinessen',
        publication: 'Encyclopaedia Iranica',
        year: '1988',
        sourceType: 'ئینسایکڵۆپیدیای ئەکادیمی'
      },
      {
        title: 'Barzani, Mulla Mustafa (1903–1979)',
        author: 'Deniz Ekici',
        publication: 'The International Encyclopedia of Revolution and Protest - Wiley',
        year: '2009',
        sourceType: 'توێژینەوەی ئەکادیمی'
      }
    ],

    imageResource: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Mustafa_Barzani.jpg',
